...
export default function GetInvolvedPage() {
  ...
  return (
    <>
      <Navbar />
      <main>
        {/* Join the Movement CTA — full image bg + form */}
        <section className="relative min-h-[100dvh] flex flex-col lg:flex-row w-full pt-20">
          ...
          <div className="lg:w-2/3 pt-10 pb-5 lg:py-10 z-[2] relative px-5 lg:pl-10 flex flex-col gap-6 justify-between">
            <h1 className="text-[#F8F6E8] text-h3 font-bold flex flex-col" style={{ fontFamily: "var(--font-heading)" }}>
