    ...
    <div className="flex flex-col min-h-dvh">
      ...
      <main id="main-content" className="flex-1 bg-mist grid-lines flex items-center justify-center px-5">
        <div className="text-center max-w-[480px]">
          ...
          <p className="font-mono text-accents uppercase text-bark/40 mb-4">Pedido confirmado</p>
          <h1 className="text-h3 font-bold text-bark font-heading mb-4">
            Obrigado pelo apoio.
          </h1>
          <p className="text-paragraphs text-bark/60 mb-10">
            100% do valor vai diretamente para a missão da Pax Brasiliana. Você receberá um email com os detalhes do pedido.
          </p>
