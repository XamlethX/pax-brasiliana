          ...
          >
            ...
            <div className="lg:w-2/3 pt-10 pb-5 lg:py-10 z-[2] relative px-5 lg:pl-10 flex flex-col gap-6 justify-between">
              ...
              <div className="lg:max-w-[412px] text-mist text-paragraphs flex flex-col gap-8">
                <p>
                  Tem algo para compartilhar, uma ideia, uma parceria ou apenas
                  quer conversar sobre o futuro do Brasil? Estamos atentos.
                </p>
                <p>
                ...
                >
                  ...
                  {status === "success" ? (
                    <div className="mt-8 flex flex-col gap-4">
                      ...
                      <p className="text-paragraphs text-bark">Mensagem enviada. Retornaremos em breve.</p>
                    </div>
                  ) : (
                    <div className="pt-5 font-mono">
                      ...
                      <textarea
                        ...
                        required
                        className="text-accents text-bark uppercase outline-none py-5 border-b border-dashed border-bark/30 w-full bg-transparent placeholder:text-bark/40 resize-none min-h-40"
                      />
                      {/* Honeypot */}
                      <input
                        type="text"
